      ...
      <div className='max-w-[1600px] mx-auto bg-[#FAFAFA] h-full'>
        ...
        <div className='bg-gradient-to-tr from-[#FCCC4C] to-[#F8A307] px-6 sm:px-10 md:px-16 lg:px-20 xl:px-28 py-2 sm:py-5 md:py-6 lg:py-8 xl:py-9 overflow-hidden'>
          <header className='flex items-center justify-between'>
            <img className='w-24 sm:w-28 md:w-32 lg:w-36 xl:w-40' src={Logo} alt="" />

            <ul className='flex items-center gap-2 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-10'>
              <li className='cursor-pointer text-[0.6rem] md:text-xs lg:text-sm font-bold text-[#1F2025]'>Pricing</li>
              <li className='cursor-pointer text-[0.6rem] md:text-xs lg:text-sm font-bold text-[#1F2025]'>FAQ</li>
              <Button className='rounded-xl md:rounded-2xl lg:rounded-3xl text-[0.6rem] md:text-xs lg:text-sm font-bold'>Download Now</Button>
            </ul>
          </header>
          ...
          <section className='grid grid-cols-1 md:grid-cols-2 items-center gap-3 mt-5 sm:mt-6 md:mt-8 lg:mt-12 xl:mt-16 relative'>
            ...
            <div className='relative'>
              ...
              <img src={SunArrow} className='absolute top-4 sm:top-10 md:top-2 left-0 sm:-left-6 md:-left-12 w-8 sm:w-10 md:w-14 lg:w-16' alt="" />
        ...
        <section className='px-6 sm:px-16 md:px-24 lg:px-32 xl:px-40 pt-6 sm:pt-10 md:pt-16 lg:pt-20 xl:pt-24 pb-6 sm:pb-8 md:pb-10 lg:pb-12 xl:pb-14'>
          <h4 className='font-bold 2xl sm:text-3xl md:texxt-4xl lg:text-5xl xl:text-6xl text-center'>Why Budgety?</h4>
        ...
        <section className='bg-[#1C1D21] px-6 sm:px-12 md:px-20 lg:px-48 xl:px-64 pt-4 sm:pt-8 md:pt-12 lg:pt-16 xl:pt-20 pb-16 sm:pb-20 md:pb-28 lg:pb-36 xl:pb-44 rounded-t-[40px] sm:rounded-t-[60px] md:rounded-t-[80px] lg:rounded-t-[100px] xl:rounded-t-[120px]'>
          <h4 className='text-[#FCCF51] font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-center'>Do More with Budgety</h4>
          ...
          <div className='mt-8 sm:mt-12 md:mt-16 lg:mt-20 xl:mt-24 flex flex-col gap-10 sm:gap-20 md:gap-28 lg:gap-40 xl:gap-52'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-center justify-between relative'>
              <div>
                <h5 className='text-[#FCCF51] font-bold text-base sm:text-xl md:text-2xl lg:text-3xl'>set up account:</h5>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-center justify-between'>
              ...
              <div className='order-1 md:order-2'>
                <h5 className='text-[#FCCF51] font-bold text-base sm:text-xl md:text-2xl lg:text-3xl'>Track Transactions</h5>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-center justify-between'>
              <div>
                <h5 className='text-[#FCCF51] font-bold text-base sm:text-xl md:text-2xl lg:text-3xl'>Monitor Budget</h5>
        ...
        <section className='px-6 sm:px-16 md:px-24 lg:px-32 xl:px-40 pb-6 sm:pb-10 md:pb-16 lg:pb-20 xl:pb-24 pt-6 sm:pt-8 md:pt-10 lg:pt-12 xl:pt-14'>
          <h4 className='text-[#000000CC] font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl text-center'>Trusted by Over 10,000 Users</h4>
          ...
          <div className='mt-6 sm:mt-10 md:mt-14 lg:mt-16 xl:mt-20 grid grid-cols-2 sm:flex gap-4 sm:gap-8 md:gap-10 lg:gap-12 justify-between'>
            <div>
              <p className='text-[#000000CC] font-bold text-base sm:text-lg md:text-xl lg:text-2xl'>Transaction Tracked</p>
              <h4 className='text-[#000000CC] font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl mt-1 sm:mt-2 md:mt-3 lg:mt-4 xl:mt-5'>10k+</h4>
            </div>

            <div className='sm:pl-8 md:pl-12 lg:pl-16 xl:pl-20 sm:border-l'>
              <p className='text-[#000000CC] font-bold text-base sm:text-lg md:text-xl lg:text-2xl'>Budget Created</p>
              <h4 className='text-[#000000CC] font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl mt-1 sm:mt-2 md:mt-3 lg:mt-4 xl:mt-5'>3.5k+</h4>
            </div>

            <div className='sm:pl-8 md:pl-12 lg:pl-16 xl:pl-20 sm:border-l'>
              <p className='text-[#000000CC] font-bold text-base sm:text-lg md:text-xl lg:text-2xl'>Average Rating</p>
              <div className='mt-1 sm:mt-2 md:mt-3 lg:mt-4 xl:mt-5'>
                <div className='flex items-center gap-1 md:gap-2'>
                  <h4 className='text-[#000000CC] font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl'>4.6</h4>
                  <img src={YellowStars} className='w-16 sm:w-20 md:w-24 lg:w-28' alt="" />
                </div>

                <p className='text-[#5E5E5E] text-[0.5rem] sm:text-[0.6rem] md:text-xs lg:text-sm'>Average rating of this year</p>
              </div>
            </div>
          </div>
        ...
        <section className='bg-[#1C1D21] py-4 sm:py-6 md:py-8 lg:py-10 px-6 sm:px-16 md:px-24 lg:px-32 xl:px-40'>
          ...
          {/* Monthly */}
          {planType === 'monthly' && <div className='grid grid-cols-1 md:grid-cols-2 mt-3 sm:mt-5 md:mt-7 lg:mt-9 xl:mt-11 gap-4 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-12'>
        ...
        <section className='py-6 sm:py-8 md:py-10 lg:py-12 xl:py-14 px-6 sm:px-16 md:px-20 lg:px-24 xl:px-28 '>
          <div className='grid grid-cols-1 md:grid-cols-2 items-center bg-[#FEC734] md:pl-14 lg:pl-16 xl:pl-20 rounded-lg sm:rounded-xl md:rounded-2xl lg:rounded-3xl overflow-hidden'>
            ...
            <div className='-mb-8 md:mb-0'>
              <img src={Sect6Img} className='w-full -ml-2.5 sm:-ml-3 md:ml-0' alt="" />
            </div>
          </div>
        </section>
