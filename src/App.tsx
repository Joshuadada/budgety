      ...
      <div className="max-w-[1600px] mx-auto bg-[#FAFAFA] h-full">
        ...
        <div className="bg-gradient-to-tr from-[#FCCC4C] to-[#F8A307] px-6 sm:px-10 md:px-16 lg:px-20 xl:px-28 py-2 sm:py-5 md:py-6 lg:py-8 xl:py-9 overflow-hidden">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 items-center gap-3 mt-5 sm:mt-6 md:mt-8 lg:mt-12 xl:mt-16 relative">
            ...
            <img
              src={SavingMoney}
              className="absolute -bottom-12 sm:-bottom-16 md:bottom-[-5.5rem] lg:-bottom-28 translate-x-1/2 right-1/2 w-32 sm:w-40 md:w-48 lg:w-56 transform scale-x-[-1]"
              alt=""
            />
            <img
              src={Coins}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center justify-between relative">
              ...
              <div className="">
                <div className="overflow-y-hidden">
                  <img
                    className="md:ml-auto  mx-auto md:mx-[unset] w-full -mb-48"
                    src={Sect3Img1}
                    alt=""
                  />
                </div>
              ...
              <img
                src={Coins}
                className="absolute md:-left-6 lg:-left-1 lg:-bottom-28 xl:-bottom-28 2xl:-bottom-4 hidden lg:block w-20 sm:w-24 md:w-24 lg:w-40 xl:w-56 2xl:w-64"
                alt=""
              />
            </div>
